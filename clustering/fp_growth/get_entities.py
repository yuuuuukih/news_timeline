...
def main():
    ...
    parser.add_argument('--rm_non_noun_verb', default=True, type=bool)
    ...
    # Basically fixed
    parser.add_argument('--max_output', default=40, type=float)
    parser.add_argument('--max_for_removed_words', default=20, type=float)
    # Others
